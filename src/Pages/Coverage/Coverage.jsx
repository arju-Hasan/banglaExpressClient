...
//     e.preventDefault();
//     const location = e.target.locations.value;
//     const district = serviceCentars.find(c => c.district.toLowerCase().includes(location.toLowerCase()));
//     if (district){
...
//             {/* secarch */}
//             <form onSubmit={handledSearch} className='border-2'>
//                 <label className='flex justify-center items-center gap-4 '>
//                 <svg className="h-[1em] pl-10 opacity-50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
//                     <g
...
//                     </g>
//                 </svg>
//                 <input type="search" className="pl-8 grow" name="locations" placeholder="Search" />
//                
//                 </label>
//             </form>
//         </div>
